...
# Define the range of n_estimators to test (100 to 400 in increments of 50)
n_estimators_range = list(range(100, 501, 50))  # [100, 150, 200, 250, 300, 350, 400]

# Lists to store accuracies and models (Change 5: Optimized model selection)
accuracies = []
models = []
...
best_n_estimators = n_estimators_range[accuracies.index(max(accuracies))]
best_accuracy = max(accuracies)
best_model = models[accuracies.index(max(accuracies))]
print(f"\nMost accurate model: {best_n_estimators} trees with accuracy {best_accuracy:.4f}")

# Plot the accuracies (Change 8: Matplotlib compatibility)
